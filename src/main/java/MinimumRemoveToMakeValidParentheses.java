...
public class MinimumRemoveToMakeValidParentheses {
	 ...
	 * We can introduce another stack to collect indexes of mismatched ')', or we can use the same stack
	 * and mark mismatched ')' somehow. Here, we just negate the index to indicate ')'.
	 * 
	...
	public String minRemoveToMakeValid(String s) {
		...
		// math.abs because now it doesnt matter if it is '(' or ')' as we just want to remove these extras
	...
	public String minRemoveToMakeValid2(String s) {
		...
		return result.toString(); // StringBuilder.toString() method is O(n)
	}
}
