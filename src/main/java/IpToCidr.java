...
public class IpToCidr {
   ...
   *  - The way I do this is splitting the string by "."s and treating each block as a digit of base 256.
   *  - Now I want to convert this base 256 number into base 10
   *
   * 2. Greedily take the biggest block of IP Addresses at each step
   *  - As mentioned before I get the number of trailing zeros. I know that this is the maximum number of bits
   *    I'm allowed to advance. I start the value at 1 just so it's easier to calculate the 32 - used.
   *
